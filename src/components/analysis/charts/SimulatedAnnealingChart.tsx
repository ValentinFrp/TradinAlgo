...
export function SimulatedAnnealingChart({
  ...
  useEffect(() => {
    ...
    if (temperatureHistory.length === 0 || fitnessHistory.length === 0) {
      return;
    }
  ...
  return (
    <ChartContainer title="Simulated Annealing Progress">
      {temperatureHistory.length > 0 && fitnessHistory.length > 0 ? (
